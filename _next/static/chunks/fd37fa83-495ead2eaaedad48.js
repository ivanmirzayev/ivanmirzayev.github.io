"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[717],{2424:function(e,t,n){n.d(t,{C:function(){return e8},X:function(){return eG},aa:function(){return e9},ab:function(){return e5},c:function(){return tO},o:function(){return nr},y:function(){return e6}});var i,r=n(8954),s=n(5723),a=n(9858),o=n(9703),l=n(6574);function c(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}let u=new r.LL("auth","Firebase",c()),h=new a.Yd("@firebase/auth");function d(e){for(var t=arguments.length,n=Array(t>1?t-1:0),i=1;i<t;i++)n[i-1]=arguments[i];h.logLevel<=a.in.ERROR&&h.error("Auth (".concat(s.Jn,"): ").concat(e),...n)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function tw(e,t){return t?Z(t):(v(e._popupRedirectResolver,e,"argument-error"),e._popupRedirectResolver)}ty.PROVIDER_ID="phone",ty.PHONE_SIGN_IN_METHOD="phone";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let tH=new w(3e4,6e4);function tW(){let e=ta().___jsl;if(null==e?void 0:e.H){for(let t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}}let tq=null,tK=new w(5e3,15e3),tG={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},tJ=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);async function tB(e){let t=await (tq=tq||new Promise((t,n)=>{var i,r,s;function a(){tW(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{tW(),n(f(e,"network-request-failed"))},timeout:tH.get()})}if(null===(r=null===(i=ta().gapi)||void 0===i?void 0:i.iframes)||void 0===r?void 0:r.Iframe)t(gapi.iframes.getContext());else if(null===(s=ta().gapi)||void 0===s?void 0:s.load)a();else{let t=ew("iframefcb");return ta()[t]=()=>{gapi.load?a():n(f(e,"network-request-failed"))},ey("https://apis.google.com/js/api.js?onload=".concat(t)).catch(e=>n(e))}}).catch(e=>{throw tq=null,e})),n=ta().gapi;return v(n,e,"internal-error"),t.open({where:document.body,url:function(e){let t=e.config;v(t.authDomain,e,"auth-domain-config-required");let n=t.emulator?T(t,"emulator/auth/iframe"):"https://".concat(e.config.authDomain,"/").concat("__/auth/iframe"),i={apiKey:t.apiKey,appName:e.name,v:s.Jn},a=tJ.get(e.config.apiHost);a&&(i.eid=a);let o=e._getFrameworks();return o.length&&(i.fw=o.join(",")),"".concat(n,"?").concat((0,r.xO)(i).slice(1))}(e),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:tG,dontclear:!0},t=>new Promise(async(n,i)=>{await t.restyle({setHideOnLeave:!1});let r=f(e,"network-request-failed"),s=ta().setTimeout(()=>{i(r)},tK.get());function a(){ta().clearTimeout(s),n(t)}t.ping(a).then(a,()=>{i(r)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
